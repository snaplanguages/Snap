window.quizData = {
  ...
  // Toàn bộ nội dung bài đọc được bọc trong chuỗi HTML với ID ev-X dẫn chứng đồng bộ
  passageContent: `
    <p class="paragraph">
  ...
  // Danh sách đáp án chính xác theo khóa ngoại của bài thi
  correctAnswers: {
    14: "C",
    15: "D",
    16: "F",
  ...
  // Hệ thống giải thích, dịch nghĩa chi tiết và từ khóa định vị dẫn chứng (Sửa dấu = thành :)
  explanations: {
    14: {
